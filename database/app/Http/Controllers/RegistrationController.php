...
class RegistrationController extends Controller
{
    ...
    public function storeYouth(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Youth School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'youth-school');
    }
    ...
    public function storeStudent(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Student School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'student-school');
    }
    ...
    public function storeWomen(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Women Entrepreneurship School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'women-school');
    }
    ...
    public function storeWorkingWomen(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Working Women Leadership & Career Growth School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'working-women-school');
    }
    ...
    public function storeJobProfessional(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Job Professional Growth School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'job-professional-school');
    }
    ...
    public function storeBusinessGrowth(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('register')
            ->with('success', "Your Business Growth School admission form has been submitted successfully. Registration Number: {$admission->registration_number}")
            ->with('active_form', 'business-growth-school');
    }
}
